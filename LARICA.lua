...
sudo_users = {SUDO,1589221252,1589221252,1589221252,1589221252}   
...
if hash or SudoBot(msg) or DevMarjonaW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevMarjonaW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMarjonaW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevMarjonaW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMarjonaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMarjonaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevMarjonaW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "MarjonaTEAM")
...
local Marjona_Msg = ''  
if msgs < 100 then 
Marjona_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
Marjona_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
Marjona_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
Marjona_Msg = 'متفاعل' 
elseif msgs < 1200 then 
Marjona_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
Marjona_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
Marjona_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
Marjona_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
Marjona_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
Marjona_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
Marjona_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
Marjona_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
Marjona_Msg = 'رب التفاعل'  
end 
return Marjona_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMarjona(msg,data) -- بداية العمل
if msg then
...
if DevMarjonaW(msg) then
local bl = ' ⌁ 🦇 اهلا عزيزي آلمـطـور\n ⌁ 🦇 آنت آلمـطـور آلآسـآسـي للبوت\n┉  ┉  ┉  ┉  ┉  ┉  ┉  ┉ء\n ⌁ 🦇 تسـتطـيع‌‏ آلتحگم باوامر البوت\n ⌁ 🦇 من خلاال الكيبورت خاص بك\n ⌁ 🦇 قناة سورس البوت [اضغط هنا](t.me/MarjonaTEAM)'
local keyboard = {
{'الاحصائيات ⌁ 🕷️','قناه تحديثات البوت ⌁ 🕷️'},
...
if start then 
SourceMarjonar = start
else
SourceMarjonar = '⌁ 🦇 اهلا عزيزي\n ⌁ 🦇 انا بوت اسمي '..Namebot..'\n ⌁ 🦇 اختصاصي حمايه الكروبات\n ⌁ 🦇 من تكرار والسبام والتوجيه والخ…\n ⌁ 🦇 لتفعيلي اتبع الاخطوات…↓\n ⌁ 🦇 اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع ↺{ منشئ او المشرفين } بتفعيل فقط\n[ ⌁ 🦇 [قناة سورس البوت](http://t.me/MarjonaTEAM)'
end 
send(msg.chat_id_, msg.id_, SourceMarjonar) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevMarjonaW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevMarjonaW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,Marjona_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌁ 🕷️' and DevMarjonaW(msg) then  
...
if text == 'تعطيل التواصل ⌁ 🕷️' and DevMarjonaW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌁ 🕷️' and DevMarjonaW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌁ 🕷️' and DevMarjonaW(msg) then  
...
if text == 'ضع كليشه ستارت ⌁ 🕷️' and DevMarjonaW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 ارسل لي الكليشه الان')
return false
end
if text == 'حذف كليشه ستارت ⌁ 🕷️' and DevMarjonaW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 تم حذف كليشه ستارت')
end
if text == 'معلومات السيرفر ⌁ 🕷️' and DevMarjonaW(msg) then 
...
if text == 'الاصدار ⌁ 🕷️' and DevMarjonaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 اصدار سورس مارجونا \n ⌁ 🦇 الاصدار ↺{ 1.3v}')
end
if text == 'قناه تحديثات البوت ⌁ 🕷️' and DevMarjonaW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 [تحديثات البوت](t.me/MarjonaTEAM) \n ⌁ 🦇 [قناه السورس](t.me/MarjonaTEAM)')
end
if text == "ضع اسم للبوت ⌁ 🕷️" and DevMarjonaW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل اليه الاسم الان ")
return false
end
if text == 'الاحصائيات ⌁ 🕷️' and DevMarjonaW(msg) then 
...
if text == 'المشتركين ⌁ 🕷️' and DevMarjonaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⌁ 🦇 المشتركين↺{`'..Users..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌁ 🕷️' and DevMarjonaW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n ⌁ 🦇 الكروبات↺{`'..Groups..'`}'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌁ 🕷️") and DevMarjonaW(msg) then
...
if text == ("قائمه العام ⌁ 🕷️") and DevMarjonaW(msg) then
...
if text == ("قائمه الكتم العام ⌁ 🕷️") and DevMarjonaW(msg) then
...
if text=="اذاعه خاص ⌁ 🕷️" and msg.reply_to_message_id_ == 0 and DevMarjonaW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل الان اذاعتك؟ \n ⌁ 🦇 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه ⌁ 🕷️" and msg.reply_to_message_id_ == 0 and DevMarjonaW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل الان اذاعتك؟ \n ⌁ 🦇 للخروج ارسل الغاء ")
return false
end  
if text=="اذاعه بالتثبيت ⌁ 🕷️" and msg.reply_to_message_id_ == 0 and DevMarjonaW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل الان اذاعتك؟ \n ⌁ 🦇 للخروج ارسل الغاء ")
return false
end 
if text=="اذاعه بالتوجيه ⌁ 🕷️" and msg.reply_to_message_id_ == 0  and DevMarjonaW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل لي التوجيه الان")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌁ 🕷️" and msg.reply_to_message_id_ == 0  and DevMarjonaW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌁ 🕷️' and DevMarjonaW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌁ 🕷️" and DevMarjonaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌁ 🕷️" and DevMarjonaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'⌁ 🦇  عدد الكروبات الان ↺ { '..#group..' }'..Marjonak..''..Marjona..'\n⌁ 🦇  الان عدد الكروبات الحقيقي ↺ { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevMarjonaW(msg) then
...
usertext = '\n ⌁ 🦇 العضو ↺ ['..result.title_..'](t.me/'..(username or 'MarjonaTEAM')..')'
status  = '\n ⌁ 🦇 تم ترقيته مطور'
...
if text and text:match("^رفع مطور (%d+)$") and DevMarjonaW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevMarjonaW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevMarjonaW(msg) then
...
local Marjona1_Msg = database:get(bot_id.."Marjona1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Marjona1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 العضو ↺ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'MarjonaTEAM')..') \n ⌁ 🦇 '..Marjona1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if Marjona_Msg and not Special(msg) then  
local Marjona_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Marjona_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌁ 🦇 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌁ 🦇 ["..Marjona_Msg.."] \n")
else
send(msg.chat_id_,0," ⌁ 🦇 العضو : {["..data.first_name_.."](T.ME/MarjonaTEAM)}\n ⌁ 🦇 ["..Marjona_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ⌁ 🦇 عذرا ↺ {["..data.first_name_.."](T.ME/MarjonaTEAM)}\n ⌁ 🦇 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevMarjonaW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevMarjonaW(msg) then
...
if text == 'تحديث السورس' and DevMarjonaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تغير الاشتراك$") and DevMarjonaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁ 🦇 حسنآ ارسل لي معرف القناة')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevMarjonaW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁ 🦇 حسنآ ارسل لي النص الذي تريده')
return false  
end
if text == "حذف رساله الاشتراك ⌁ 🕷️" and DevMarjonaW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " ⌁ 🦇 تم مسح رساله الاشتراك ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌁ 🕷️$") and DevMarjonaW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' ⌁ 🦇 حسنآ ارسل لي معرف القناة')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌁ 🕷️" and DevMarjonaW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌁ 🕷️" and DevMarjonaW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " ⌁ 🦇 تم تعطيل الاشتراك الاجباري ")
return false  
end
if text == "الاشتراك الاجباري ⌁ 🕷️" and DevMarjonaW(msg) then  
...
database:sadd(bot_id.."Marjona:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Marjona:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Marjona = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Marjona then 
names_Marjona = database:smembers(bot_id.."Marjona:blocname"..msg.chat_id_) or ""
if names_Marjona and names_Marjona[1] then 
for i=1,#names_Marjona do 
if name_Marjona:match("(.*)("..names_Marjona[i]..")(.*)") then 
...
database:set(bot_id.."Marjona:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Marjona:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Marjona:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Marjona:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Marjona:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Marjonaa_new(Marjona1,Marjona2)
if Marjona2 and Marjona2.first_name_ then 
if Marjona2.first_name_:match("(.*)"..database:get(bot_id.."Marjona:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Marjona:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Marjona_nnn = database:get(bot_id.."Marjona:nump"..msg.chat_id_) or 5
local Marjona_nnn2 = database:get(bot_id.."Marjona:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Marjona_nnn2) == tonumber(Marjona_nnn) or tonumber(Marjona_nnn2) > tonumber(Marjona_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Marjona:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌁ 🦇 عزيزي >>["..Marjona2.username_.."](https://t.me/"..(Marjona2.username_ or "MarjonaTEAM")..")\n⌁ 🦇 عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Marjona:teh"..msg.chat_id_).."} بجانب اسمك\n⌁ 🦇 عدد المحاولات المتبقيه {"..(tonumber(Marjona_nnn) - tonumber(Marjona_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Marjonaa_new)
end
end
...
local MarjonaChengName = database:get(bot_id.."Marjona:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MarjonaChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MarjonaChengName..']')
database:del(bot_id.."Marjona:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MarjonaChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Marjona:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MarjonaChengUserName = database:get(bot_id.."Marjona:Cheng:UserName"..data.id_)
if not data.username_ then 
if MarjonaChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MarjonaChengUserName..']')
database:del(bot_id.."Marjona:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MarjonaChengUserName ~= data.username_ then 
local Text = {
'شفتك ترا نشروك بقناه 18+ وغيرتك يوزرك',
"رجع يوزرك القديم شكلك مو مال تمبلر ",
"لح لح يوميه يوزر شكل",
...
database:set(bot_id.."Marjona:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MarjonaChengPhoto = database:get(bot_id.."Marjona:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MarjonaChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Marjona:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MarjonaChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
  "صورتك كرنج للنعال",
  "معيدي ولطش بصوره",
  "معيدي وخله صوره تمبلر ولح",
  "شبيك كل شوي صوره هي معيدي؟ ",
  "خامط صوره وصاير تمبلر براسي؟ ",
  "رجع صورتك لكرنج",
}
send(msg.chat_id_, msg.id_,Text[math.random(#Text)])
end  
database:set(bot_id.."Marjona:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ 
● ⌁ ↺[𝗟𝗮𝗥𝗜𝗖𝗮 𝗧𝗘𝗮𝗺](t.me/MarjonaTEAM) 
⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ 
 ● ⌁ ↺[𝗗𝗘𝗩𝗘𝗟𝗢𝗣𝗘𝗥](t.me/F40FF)
⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ 
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == 'رفع نسخه الاحتياطيه' and DevMarjonaW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'جلب نسخه الاحتياطيه' and DevMarjonaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ⌁ 🦇 بواسطه ↺ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'MarjonaTEAM')..') \n ⌁ 🦇 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌁ 🦇 بواسطه ↺ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'MarjonaTEAM')..') \n ⌁ 🦇 تـم قفـل التاك بالكتم ')
end,nil)   
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث' and DevMarjonaW(msg) then    
dofile('Marjona.lua')  
send(msg.chat_id_, msg.id_, ' ⌁ 🦇 تم تحديث جميع الملفات') 
end 
if text == ("مسح قائمه العام") and DevMarjonaW(msg) then
database:del(bot_id..'GBan:User')
send(msg.chat_id_, msg.id_, '\n ⌁ 🦇 تم مسح قائمه العام')
return false
end
if text == ("قائمه العام") and DevMarjonaW(msg) then
local list = database:smembers(bot_id..'GBan:User')
t = "\n ⌁ 🦇 قائمة المحظورين عام \n  ⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevMarjonaW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevMarjonaW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevMarjonaW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevMarjonaW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevMarjonaW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevMarjonaW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevMarjonaW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevMarjonaW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevMarjonaW(msg) then
...
------------------------------------------------------------------------
if text == ("مسح المطورين") and DevMarjonaW(msg) then
database:del(bot_id..'Sudo:User')
send(msg.chat_id_, msg.id_, "\n ⌁ 🦇 تم مسح قائمة المطورين  ")
end
if text == ("المطورين") and DevMarjonaW(msg) then
local list = database:smembers(bot_id..'Sudo:User')
t = "\n ⌁ 🦇 قائمة مطورين البوت \n  ⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ \n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevMarjonaW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevMarjonaW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "MarjonaTEAM")
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ⌁ 🦇 لعضو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'MarjonaTEAM')..')'
status  = '\n ⌁ 🦇 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ⌁ 🦇 العضو ↺ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ⌁ 🦇 العضــو ↺ ['..data.first_name_..'](t.me/'..(data.username_ or 'MarjonaTEAM')..')'
...
database:set(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Marjona1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Marjona1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," ⌁ 🦇 تم منع الكلمه مع التحذير")  
database:del(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Marjona1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Marjona1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Marjona1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," ⌁ 🦇 ارسل الكلمه الان")  
database:set(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Marjona1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Marjona1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Marjona1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Marjona1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Marjona1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Marjona1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n ⌁ 🦇 قائمة المنع \n  ⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ \n"
for k,v in pairs(list) do  
local Marjona_Msg = database:get(bot_id.."Marjona1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." ↺ {"..Marjona_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevMarjonaW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' ⌁ 🦇 تم مسح كليشه المطور')
end
if text == 'ضع كليشه المطور' and DevMarjonaW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌁ 🦇 العضو ↺ ['..result.title_..'](t.me/'..(text1[3] or 'MarjonaTEAM')..')'..'\n ⌁ 🦇 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevMarjonaW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevMarjonaW(msg) then  
...
if text == 'تفعيل التواصل' and DevMarjonaW(msg) then  
if database:get(bot_id..'Tuasl:Bots') then
database:del(bot_id..'Tuasl:Bots') 
Text = '\n ⌁ 🦇 تم تفعيل التواصل' 
else
...
if text == 'تعطيل التواصل' and DevMarjonaW(msg) then  
if not database:get(bot_id..'Tuasl:Bots') then
database:set(bot_id..'Tuasl:Bots',true) 
Text = '\n ⌁ 🦇 تم تعطيل التواصل' 
else
...
if text == 'تفعيل البوت الخدمي' and DevMarjonaW(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تعطيل البوت الخدمي' and DevMarjonaW(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارجونا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'مارجونا')
local Marjona_Msg = {
'عمري اللطيف 🍭🤍.',
'ها يحيل مارجونا 🦦💞.',
'معيدي وشاف بوت هايول.',
'كول حبيبي ؟ اني '..Namebot..'',
'عوفوني ضايج',
'عمري فداك '..Namebot..' كول حب'
}
send(msg.chat_id_, msg.id_,'['..Marjona_Msg[math.random(#Marjona_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevMarjonaW(msg) then 
...
if text == ("مسح ردود المطور") and DevMarjonaW(msg) then 
...
if text == ("ردود المطور") and DevMarjonaW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌁ 🦇 قائمة ردود المطور \n  ⌯ 𝐋𝐀𝐑𝐈𝐂𝐀 ✞ 𝐓𝐄𝐀𝐌 ||🦇 ꙰ \n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevMarjonaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevMarjonaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'مارجونا').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevMarjonaW(msg) then   
...
if text == 'تعطيل المغادره' and DevMarjonaW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'MarjonaTEAM')..')'
local iduser = result.sender_user_id_
...
local rtpg = rtpa
local amira = {
" ⌁ 🦇 دروح بابا روح لا خلي الكروب يضحك عليك",
" ⌁ 🦇 من تجيب تمبلر من سوك هرج",
" ⌁ 🦇 صوره زغبه",
" ⌁ 🦇 هنا الكرنج ياب",
" ⌁ 🦇 لح لح بعد لح ",
" ⌁ 🦇 هنا التمبلر تع ابوسك يروح مارجونا 💕🍭 ",
" ⌁ 🦇 منو ضاحك عليك ومنطيك هلصوره؟  ",
" ⌁ 🦇 معيدي وخله صوره تمبلر ",
}
...
if text == "تنظيف المشتركين" and DevMarjonaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات" and DevMarjonaW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-- vardump(data) 
Marjonadx(msg.chat_id_, msg.id_, ' ⌁ 🦇 ايدي المجموعة ↺ ( '..msg.chat_id_..' )\n ⌁ 🦇 عدد الادمنيه ↺ ( *'..data.administrator_count_..' )*\n ⌁ 🦇 عدد المحظورين ↺ ( *'..data.kicked_count_..' )*\n ⌁ 🦇 عدد الاعضاء ↺ ( *'..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevMarjonaW(msg) then
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
Marjona = {'22','30','33','60','90','2','5','36','16','88','50','10','19',};
name = Marjona[math.random(#Marjona)]
...
if database:get(bot_id..'Lock:Games'..msg.chat_id_) then
Marjona = {'معلومات','قنوات','مجموعات','كتاب','تفاحه','مختلف','سدني','فلوس','اعلم','ذئب','تمساح','ذكي',};
name = Marjona[math.random(#Marjona)]
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"هاذا فرخ يضل يمضرط","واحد فرخ هاذ شترجه منه","واحد دودكي هاذ عوفه حرامات اوصخ لساني بي🤣"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'مارجونا')
...
Marjona = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Marjona)
...
--------------------------------------------------------------------------------------------------------------
SourceMarjona(data.message_,data)
...
------------------------------------------------------------------------
local MarjonaAbot = database:get(bot_id.."Marjona1:Add:Filter:Rp2"..text..result.chat_id_)   
if MarjonaAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," ⌁ 🦇 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n ⌁ 🦇 ["..MarjonaAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Marjona1_Msg = database:get(bot_id.."Marjona1:Add:Filter:Rp2"..text..result.chat_id_)   
if Marjona1_Msg then    
send(msg.chat_id_, msg.id_," ⌁ 🦇 "..Marjona1_Msg)
