...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./KYROSU.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("KU", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S KYROSU -X kill
screen -S KYROSU ./KYROSU
done
]])  
file:close() 
...
sudo_users = {SUDO,1466244479,539371484}   
...
if hash or SudoBot(msg) or DevKYROSUW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevKYROSUW(msg) or Sudo(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKYROSUW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevKYROSUW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKYROSUW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKYROSUW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
end 
...
if hash or SudoBot(msg) or DevKYROSUW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then       
return true 
else 
return false 
end 
...
var = true  
elseif tonumber(user_id) == tonumber(539371484) then
var = true  
...
if tonumber(user_id) == tonumber(1466244479) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(53937148) then
...
local UserName = (data.username_ or "anx990")
...
local KYROSU_Msg = ''  
if msgs < 100 then 
KYROSU_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
KYROSU_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
KYROSU_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
KYROSU_Msg = 'متفاعل' 
elseif msgs < 1200 then 
KYROSU_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
KYROSU_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
KYROSU_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
KYROSU_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
KYROSU_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
KYROSU_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
KYROSU_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
KYROSU_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
KYROSU_Msg = 'رب التفاعل'  
end 
return KYROSU_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@moamelz")  
...
--------------------------------------------------------------------------------------------------------------
function SourceKYROSU(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
SourceKYROSUr = '*⌯︙اهلا عزيزي*\n*⌯︙انا بوت اسمي '..Namebot..'*\n*⌯︙اختصاصي حمايه الكروبات*\n*⌯︙من تكرار والسبام والتوجيه والخ…*\n*⌯︙لتفعيلي اتبع الاخطوات…↓*\n*⌯︙اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط*\n⌯︙[قناة سورس البوت](http://t.me/anx990)'
end
send(msg.chat_id_, msg.id_, SourceKYROSUr) 
end
end
database:setex(bot_id..'Start:Time'..msg.sender_user_id_,300,true)
return false
end
if not DevKYROSUW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevKYROSUW(msg) and msg.reply_to_message_id_ ~= 0  then    
...
send(msg.chat_id_, msg.id_,KYROSU_Msg) 
return false  
end 
if text then    
...
if text == 'تفعيل التواصل ⌯' and DevKYROSUW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevKYROSUW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevKYROSUW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevKYROSUW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevKYROSUW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevKYROSUW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevKYROSUW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevKYROSUW(msg) then 
os.execute('rm -rf KYROSU.lua')
os.execute('wget https://raw.githubusercontent.com/KYROSUTEAM/KYROSU/main/KYROSU.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس تيلاند*\n*⌯︙الاصدار » { 2.8v}*')
dofile('KYROSU.lua')  
end
if text == 'الاصدار ⌯' and DevKYROSUW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس تيلاند* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevKYROSUW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/KYROSUTEAM) \n⌯︙[قناه السورس](t.me/anx990)')
end
if text == "ضع اسم للبوت ⌯" and DevKYROSUW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevKYROSUW(msg) then 
...
if text == 'المشتركين ⌯' and DevKYROSUW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevKYROSUW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevKYROSUW(msg) then
...
if text == ("قائمه العام ⌯") and DevKYROSUW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevKYROSUW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevKYROSUW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevKYROSUW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevKYROSUW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevKYROSUW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevKYROSUW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevKYROSUW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevKYROSUW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == "تنظيف الكروبات ⌯" and DevKYROSUW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..KYROSUk..''..KYROSU..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevKYROSUW(msg) then
...
usertext = '*\n ⌯︙العضو »* ['..result.title_..'](t.me/'..(username or 'anx990')..')'
status  = '\n *⌯︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevKYROSUW(msg) then
...
usertext = '\n *⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'anx990')..')'
status  = '\n*⌯︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevKYROSUW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevKYROSUW(msg) then
...
local KYROSU1_Msg = database:get(bot_id.."KYROSU1:Add:Filter:Rp2"..text..msg.chat_id_)   
if KYROSU1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'anx990')..') \n ⌯︙'..KYROSU1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if KYROSU_Msg and not Special(msg) then  
local KYROSU_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if KYROSU_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..KYROSU_Msg.."] \n")
else
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/anx990)}\n⌯︙["..KYROSU_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " *⌯︙عذرا »* {["..data.first_name_.."](T.ME/anx990)}\n*⌯︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevKYROSUW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevKYROSUW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevKYROSUW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevKYROSUW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevKYROSUW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevKYROSUW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevKYROSUW(msg) then  
if database:get(bot_id..'add:ch:id') then
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevKYROSUW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevKYROSUW(msg) then  
...
database:sadd(bot_id.."KYROSU:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."KYROSU:blocname"..msg.chat_id_)
...
function moamelz_name(t1,t2)
if t2.id_ then 
name_KYROSU = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_KYROSU then 
names_KYROSU = database:smembers(bot_id.."KYROSU:blocname"..msg.chat_id_) or ""
if names_KYROSU and names_KYROSU[1] then 
for i=1,#names_KYROSU do 
if name_KYROSU:match("(.*)("..names_KYROSU[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, moamelz_name)
end
...
database:set(bot_id.."KYROSU:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."KYROSU:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."KYROSU:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."KYROSU:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."KYROSU:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_KYROSUa_new(KYROSU1,KYROSU2)
if KYROSU2 and KYROSU2.first_name_ then 
if KYROSU2.first_name_:match("(.*)"..database:get(bot_id.."KYROSU:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."KYROSU:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local KYROSU_nnn = database:get(bot_id.."KYROSU:nump"..msg.chat_id_) or 5
local KYROSU_nnn2 = database:get(bot_id.."KYROSU:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(KYROSU_nnn2) == tonumber(KYROSU_nnn) or tonumber(KYROSU_nnn2) > tonumber(KYROSU_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."KYROSU:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..KYROSU2.username_.."](https://t.me/"..(KYROSU2.username_ or "anx990")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."KYROSU:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(KYROSU_nnn) - tonumber(KYROSU_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_KYROSUa_new)
end
end
...
local KYROSUChengName = database:get(bot_id.."KYROSU:Cheng:Name"..data.id_)
if not data.first_name_ then 
if KYROSUChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..KYROSUChengName..']')
database:del(bot_id.."KYROSU:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if KYROSUChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."KYROSU:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local KYROSUChengUserName = database:get(bot_id.."KYROSU:Cheng:UserName"..data.id_)
if not data.username_ then 
if KYROSUChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..KYROSUChengUserName..']')
database:del(bot_id.."KYROSU:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if KYROSUChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."KYROSU:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local KYROSUChengPhoto = database:get(bot_id.."KYROSU:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if KYROSUChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."KYROSU:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if KYROSUChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."KYROSU:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = [[
*أهلاً بك في السوࢪس* [KYROSU TEAM💘](t.me/KYROSUTEAM)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'قناه السوࢪس 💘',url="https://t.me/KYROSUTEAM"},
},
{
{text = 'لتنصيب السوࢪس 💘',url="https://t.me/KYROSUTEAM/3"},
},
{
{text = 'تواصل السوࢪس 💘',url="t.me/moamelzbot"},
},
{
{text = 'مطوࢪ السوࢪس 💘',url="t.me/moamelz"},
},
}
...
if text == 'رفع نسخه الاحتياطيه' and DevKYROSUW(msg) then   
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'anx990')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'anx990')..') \n*⌯︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevKYROSUW(msg) then    
dofile('KYROSU.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevKYROSUW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevKYROSUW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^حظر عام @(.*)$")  and DevKYROSUW(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevKYROSUW(msg) then
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevKYROSUW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^كتم عام @(.*)$")  and DevKYROSUW(msg) then
...
if text and text:match("^كتم عام (%d+)$") and DevKYROSUW(msg) then
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevKYROSUW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^الغاء العام @(.*)$") and DevKYROSUW(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevKYROSUW(msg) then
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevKYROSUW(msg) then
...
if database:get(bot_id.."moamelz:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'moamelz:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == ("رفع مطور") and msg.reply_to_message_id_ and DevKYROSUW(msg) then
function start_function(extra, result, success)
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevKYROSUW(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local UserName = (b.username_ or "anx990")
...
function Function_KYROSU(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_KYROSU, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_KYROSU, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *⌯︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'anx990')..')'
status  = '\n*⌯︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *⌯︙العضو »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *⌯︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'anx990')..')'
...
database:set(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."KYROSU1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."KYROSU1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."KYROSU1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."KYROSU1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."KYROSU1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KYROSU1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."KYROSU1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."KYROSU1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."KYROSU1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."KYROSU1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."KYROSU1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n *⌯︙قائمة المنع* \n*•━━━━━━ KY ━━━━━━━•*\n"
for k,v in pairs(list) do  
local KYROSU_Msg = database:get(bot_id.."KYROSU1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..KYROSU_Msg.."}\n"    
end  
if #list == 0 then  
...
if text == 'مسح كليشه المطور' and DevKYROSUW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevKYROSUW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *⌯︙العضو »* ['..result.title_..'](t.me/'..(text1[3] or 'anx990')..')'..'\n*⌯︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevKYROSUW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevKYROSUW(msg) then  
...
if not database:get(bot_id..'moamelz:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'moamelz:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..KYROSU_Msg[math.random(#KYROSU_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevKYROSUW(msg) then 
...
if text == ("مسح ردود المطور") and DevKYROSUW(msg) then 
...
if text == ("ردود المطور") and DevKYROSUW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n *⌯︙قائمة ردود المطور* \n*•━━━━━━ KY ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevKYROSUW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'حذف رد للكل' and DevKYROSUW(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل المغادره' and DevKYROSUW(msg) then   
...
if text == 'تعطيل المغادره' and DevKYROSUW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'KYROSU')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'anx990')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
KYROSUdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevKYROSUW(msg) then
...
send(msg.chat_id_, msg.id_, t..'ٴ⌯∫ٴ*•━━━━━━ KY ━━━━━━━•*ٴ⌯∫○ٴ\n⌯︙[KYROSU TEAM](t.me/anx990) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'KYROSU TEAM.',url="t.me/KYROSUTEAM"}},
}
local msg_id = msg.id_/2097152/0.5
...
KYROSU = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(KYROSU)
...
--------------------------------------------------------------------------------------------------------------
SourceKYROSU(data.message_,data)
...
------------------------------------------------------------------------
local KYROSUAbot = database:get(bot_id.."KYROSU1:Add:Filter:Rp2"..text..result.chat_id_)   
if KYROSUAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..KYROSUAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local KYROSU1_Msg = database:get(bot_id.."KYROSU1:Add:Filter:Rp2"..text..result.chat_id_)   
if KYROSU1_Msg then    
send(msg.chat_id_, msg.id_," ⌯︙"..KYROSU1_Msg)
